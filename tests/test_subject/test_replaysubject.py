...
def test_infinite():
    ...
    def action2(scheduler, state=None):
        subscription[0] = xs.subscribe(subject[0].on_next,
                                       subject[0].on_error,
...
def test_replay_subject_dies_out():
    ...
    def action2(scheduler, state=None):
        xs.subscribe(subject[0].on_next,
                     subject[0].on_error,
                     subject[0].on_completed)
    scheduler.schedule_absolute(200, action2)

    def action3(scheduler, state=None):
        subject[0].subscribe(results1.on_next,
                             results1.on_error,
                             results1.on_completed)
    scheduler.schedule_absolute(300, action3)

    def action4(scheduler, state=None):
        subject[0].subscribe(results2.on_next,
                             results2.on_error,
                             results2.on_completed)
    scheduler.schedule_absolute(400, action4)

    def action5(scheduler, state=None):
        subject[0].subscribe(results3.on_next,
                             results3.on_error,
                             results3.on_completed)
    scheduler.schedule_absolute(600, action5)

    def action6(scheduler, state=None):
        subject[0].subscribe(results4.on_next,
                             results4.on_error,
                             results4.on_completed)
    scheduler.schedule_absolute(900, action6)
