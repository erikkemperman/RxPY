...
def test_infinite():
    ...
    def action2(scheduler, state=None):
        subscription[0] = xs.subscribe(s[0].on_next,
                                       s[0].on_error,
                                       s[0].on_completed)
